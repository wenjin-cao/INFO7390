...
setwd("/Users/ling/Documents/INFO 7390 Data Science/Assignment/Assignment 1/")
...
weather = getWeatherForDate("KBOS","2014-01-01", "2014-12-31",opt_detailed = T,opt_all_columns = T)
...
for(i in 1:length(list)){
  if(is.na(list[i])){
    data[i,3]= (data[i-1,3]+data[i+1,3])/2
...
write.table(data, "ready-data.csv", sep="," ,row.name=F)
